...
**Team Name:** BargainBox  
**Github:** [GitHub Repo Link](https://github.com/EECS3311F24/project-bargainbox)  
...
## competition.md (Max 2 marks)
  ...
  competition.md Total Mark: 1 / 2 (Differences mentioned (review, free account,
  loxation based searching) are also available in other places like Kijiji. Not
  clear how BargainBox stands out.)
...
## Documentation: README.md (max 3 marks)
  ...
  - Contribution
    ...
    Your mark: 0 (Contribution flow (branch naming, if PR used), ticketing system
    not mentioned.)  
...
## User experience: (max 4 marks)
  ...
  - Graphic representation is clear and represents well indended user interface elements (max 2 marks)
    ...
    Your mark: 1 (Designs are not descriptive at all. For example, instead
    of showing a text 'User Profile', actually show a design of what will be shown
    (Photo, Name, Account age, etc.). Also, I don't understand why I should see
    Login window and User Profile window in the same page. If I'm seeing my user 
    profile, am I not already logged in?) 
